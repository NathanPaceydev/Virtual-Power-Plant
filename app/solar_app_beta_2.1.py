...
# Create labels and entry widgets for solar input
solar_input_frame = tk.Frame(solar_tab)
solar_input_frame.pack(side=tk.LEFT, padx=10, pady=10)

surface_area_label = tk.Label(solar_input_frame, text="Surface Area (m^2):")
surface_area_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")
surface_area_entry = tk.Entry(solar_input_frame)
surface_area_entry.grid(row=0, column=1, padx=5, pady=5)

address_label = tk.Label(solar_input_frame, text="Postal Code:")
address_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")
address_entry = tk.Entry(solar_input_frame)
address_entry.grid(row=1, column=1, padx=5, pady=5)

array_type_label = tk.Label(solar_input_frame, text="Array Type (0-5):")
array_type_label.grid(row=2, column=0, padx=5, pady=5, sticky="w")
array_type_entry = tk.Entry(solar_input_frame)
array_type_entry.grid(row=2, column=1, padx=5, pady=5)

module_type_label = tk.Label(solar_input_frame, text="Module Type (0-2):")
module_type_label.grid(row=3, column=0, padx=5, pady=5, sticky="w")
module_type_entry = tk.Entry(solar_input_frame)
module_type_entry.grid(row=3, column=1, padx=5, pady=5)

system_loss_label = tk.Label(solar_input_frame, text="System Loss (%):")
system_loss_label.grid(row=4, column=0, padx=5, pady=5, sticky="w")
system_loss_entry = tk.Entry(solar_input_frame)
system_loss_entry.grid(row=4, column=1, padx=5, pady=5)

tilt_label = tk.Label(solar_input_frame, text="Tilt (0-90 degrees):")
tilt_label.grid(row=5, column=0, padx=5, pady=5, sticky="w")
tilt_entry = tk.Entry(solar_input_frame)
tilt_entry.grid(row=5, column=1, padx=5, pady=5)

calculate_button = tk.Button(solar_input_frame, text="Calculate", command=get_solar_data)
